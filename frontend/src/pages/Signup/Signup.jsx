...
import { Globe, Mail, Lock, User, ArrowRight, CheckCircle2, Shield } from 'lucide-react';
      ...
      <div className="max-w-5xl w-full bg-white rounded-[3rem] border border-slate-200 shadow-2xl overflow-hidden flex flex-col md:flex-row">
        ...
        <div className="hidden md:flex md:w-5/12 bg-slate-950 p-12 flex-col justify-between relative overflow-hidden">
          <div className="relative z-10">
            <div className="flex items-center gap-2 mb-12">
              ...
              <span className="text-xl font-black tracking-tight text-white">AuditFlow</span>
            </div>
          ...
          <div className="relative z-10 p-6 bg-white/5 rounded-2xl border border-white/10 backdrop-blur-sm">
            <div className="flex items-center gap-3 mb-2">
              ...
              <span className="text-xs font-black text-white uppercase tracking-widest">Enterprise Grade</span>
            </div>
            <p className="text-[11px] text-slate-500 font-bold">Your data is encrypted and never shared with third parties.</p>
          </div>
        ...
        <div className="flex-1 p-8 md:p-16">
          <div className="max-w-sm mx-auto">
            ...
            <p className="text-slate-500 font-bold mb-10">Join 2,000+ developers optimizing today.</p>
            ...
            <form className="space-y-5">
              ...
              <button className="w-full h-16 bg-slate-900 hover:bg-slate-800 text-white rounded-2xl font-black text-sm transition-all shadow-xl shadow-slate-200 flex items-center justify-center gap-2 group">
